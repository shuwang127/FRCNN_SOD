...
import datasets
import datasets.kakou # timely modified
import os
...
class kakou(datasets.imdb):
    def __init__(self, image_set, devkit_path):
        ...
        self._classes = ('__background__', 'car') # timely : __background__ is always zero.
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(self._data_path, 'ImageSets', 'Main', 'trainlist.txt')
...
#        if int(self._year) == 2007 or self._image_set != 'test':
    ...
    def _load_selective_search_roidb(self, gt_roidb):
        filename = os.path.abspath(os.path.join(self.cache_path, '..',
                                                'CARdevkit2015', 'CAR2015',  'SelectiveSearchData', 
                                                'car_2015_train.mat'))
        ...
        for i in xrange(raw_data.shape[0]):
            box_list.append(raw_data[i][:, (1, 0, 3, 2)] - 1) #MATLAB(y1 x1 y2 x2) -> (x1 y1 x2 y2)-1
